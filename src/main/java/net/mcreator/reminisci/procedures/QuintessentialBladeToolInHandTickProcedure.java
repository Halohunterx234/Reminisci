...
public class QuintessentialBladeToolInHandTickProcedure extends ReminisciModElements.ModElement {
	public QuintessentialBladeToolInHandTickProcedure(ReminisciModElements instance) {
		super(instance, 57);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ReminisciMod.LOGGER.warn("Failed to load dependency entity for procedure QuintessentialBladeToolInHandTick!");
			return;
		}
