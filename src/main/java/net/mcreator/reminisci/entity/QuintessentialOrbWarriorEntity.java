...
public class QuintessentialOrbWarriorEntity extends ReminisciModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 1.8f)).build("quintessential_orb_warrior").setRegistryName("quintessential_orb_warrior");
	public QuintessentialOrbWarriorEntity(ReminisciModElements instance) {
		super(instance, 35);
