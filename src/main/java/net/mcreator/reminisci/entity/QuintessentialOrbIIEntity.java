...
import net.mcreator.reminisci.procedures.QuintessentialOrbIIOnInitialEntitySpawnProcedure;
import net.mcreator.reminisci.procedures.QuintessentialOrbEntityIsHurtProcedure;
import net.mcreator.reminisci.item.EssenseofDawnItem;
import net.mcreator.reminisci.entity.renderer.QuintessentialOrbIIRenderer;
...
public class QuintessentialOrbIIEntity extends ReminisciModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("quintessential_orb_ii").setRegistryName("quintessential_orb_ii");
	public QuintessentialOrbIIEntity(ReminisciModElements instance) {
		super(instance, 115);
		FMLJavaModLoadingContext.get().getModEventBus().register(new QuintessentialOrbIIRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("quintessential_orb_ii_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 20;
			setNoAI(false);
			setCustomName(new StringTextComponent("Grand Lucius- Defender of Light Awakened"));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(EssenseofDawnItem.block, (int) (1)));
		}
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			Entity entity = this;
			{
				...
				QuintessentialOrbIIOnInitialEntitySpawnProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			double z = this.getPosZ();
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				QuintessentialOrbPlayerCollidesWithThisEntityProcedure.executeProcedure($_dependencies);
			}
		}
